...
RV1=read.csv("revisits_12min_threshold with vedba2023_2_hour.csv")
RV1=RV1[,-1]
...
write.csv(RV1,file = "revisits_12min_threshold with vedba2023_2_hour.csv")
...
write.csv(RV2_sum,file = "Daily_stats_for_Ben_2023_2_hour_updated.csv")
