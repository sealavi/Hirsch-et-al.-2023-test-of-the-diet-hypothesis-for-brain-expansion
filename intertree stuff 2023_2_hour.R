...
for(i in 1:length(datasplit)){
  mintime = datasplit[[i]]$timestamp[1]+lubridate::hours(2)
...
write.csv(visitdata2, file="revisits_12min_threshold 2023_2_hour.csv")
gc()
...
#write.csv(visitdata2, file="revisits_12min_threshold with vedba2023_2_hour.csv")
gc()
