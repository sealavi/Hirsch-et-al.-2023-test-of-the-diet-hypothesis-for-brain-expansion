...
library(ctmm)
library(sp)
#Load interpolated tracks (loaded in chunks becaue they were run in parallel in chunks)
...
write.csv(visitdata2, file="revisits_12min_threshold 2023.csv")
gc()

#Add vedba data to tree visit data
...
write.csv(visitdata2, file="revisits_12min_threshold with vedba2023.csv")
gc()

#calculate vedba summary statistics
visitdata2$trip_vedba=NA
visitdata2$trip_vedba_mean=NA
